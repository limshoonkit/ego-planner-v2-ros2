...
def generate_launch_description():
    ...
    map_size_x_arg = DeclareLaunchArgument('map_size_x')
    map_size_y_arg = DeclareLaunchArgument('map_size_y')
    map_size_z_arg = DeclareLaunchArgument('map_size_z')
    init_x_arg = DeclareLaunchArgument('init_x')
    init_y_arg = DeclareLaunchArgument('init_y')
    init_z_arg = DeclareLaunchArgument('init_z')
    flight_type_arg = DeclareLaunchArgument('flight_type', default_value='2')
    point_num_arg = DeclareLaunchArgument('point_num', default_value='1')
    
    # Target waypoint arguments
    target0_x_arg = DeclareLaunchArgument('target0_x', default_value='0.0')
    target0_y_arg = DeclareLaunchArgument('target0_y', default_value='0.0')
    target0_z_arg = DeclareLaunchArgument('target0_z', default_value='0.0')
    target1_x_arg = DeclareLaunchArgument('target1_x', default_value='0.0')
    target1_y_arg = DeclareLaunchArgument('target1_y', default_value='0.0')
    target1_z_arg = DeclareLaunchArgument('target1_z', default_value='0.0')
    target2_x_arg = DeclareLaunchArgument('target2_x', default_value='0.0')
    target2_y_arg = DeclareLaunchArgument('target2_y', default_value='0.0')
    target2_z_arg = DeclareLaunchArgument('target2_z', default_value='0.0')
    target3_x_arg = DeclareLaunchArgument('target3_x', default_value='0.0')
    target3_y_arg = DeclareLaunchArgument('target3_y', default_value='0.0')
    target3_z_arg = DeclareLaunchArgument('target3_z', default_value='0.0')
    target4_x_arg = DeclareLaunchArgument('target4_x', default_value='0.0')
    target4_y_arg = DeclareLaunchArgument('target4_y', default_value='0.0')
    target4_z_arg = DeclareLaunchArgument('target4_z', default_value='0.0')
    ...
    target0_x = LaunchConfiguration('target0_x')
    target0_y = LaunchConfiguration('target0_y')
    target0_z = LaunchConfiguration('target0_z')
    target1_x = LaunchConfiguration('target1_x')
    target1_y = LaunchConfiguration('target1_y')
    target1_z = LaunchConfiguration('target1_z')
    target2_x = LaunchConfiguration('target2_x')
    target2_y = LaunchConfiguration('target2_y')
    target2_z = LaunchConfiguration('target2_z')
    target3_x = LaunchConfiguration('target3_x')
    target3_y = LaunchConfiguration('target3_y')
    target3_z = LaunchConfiguration('target3_z')
    target4_x = LaunchConfiguration('target4_x')
    target4_y = LaunchConfiguration('target4_y')
    target4_z = LaunchConfiguration('target4_z')
